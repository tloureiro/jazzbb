...
- **Paste unformatted**: `Ctrl+Shift+V` on Windows/Linux or `Cmd+Option+Shift+V` on macOS pastes clipboard text as plain Markdown without inheriting heading/paragraph styles.
